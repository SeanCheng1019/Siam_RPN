...
if __name__ == '__main__':
    ...
    for i in range(40, 41):
        ...
        model_path = '../data/models/siamrpn_stmm_nocombine_epoch_{}.pth'.format(i)
        ...
        experiments = [
            ...
            ExperimentOTB('/home/csy/dataset/dataset/OTB100/Benchmark', version=2015,
                           result_dir='results/select_template/epoch{}'.format(i),
                           report_dir='reports/select_template/epoch{}'.format(i))
